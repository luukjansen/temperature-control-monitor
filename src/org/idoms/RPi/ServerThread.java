...
public class ServerThread implements Runnable {
    ...
    public ServerThread(InetAddress address, boolean debug) {
        this.address = address;
        this.debug = debug;
    }
    ...
    private String getDataJsonString() throws Exception {
        ...
        HashMap<String, Float> sensorList = new HashMap<String, Float>();
        ...
        for (Map.Entry<String, Float> entry : sensorList.entrySet()) {
            if (!firstSensor) JSON += ",";
            JSON += "{\"sensor\":\"" + entry.getKey() + "\",\"temp\":" + entry.getValue() + "}";
            firstSensor = false;
        }
